...
function buildCharts(sample) {
  ...
  var samples2 = data.metadata;
  var sampleArray2 = samples2.filter(meta => meta.id == sample);
 
  var result2 = sampleArray2[0];
  
  var gauge_chart_val = result2.wfreq;
 

  // 4. Create the trace for the gauge chart.
  var trace3 = {
    domain: { x: [0, 1], y: [0, 1] },
    value: gauge_chart_val,
